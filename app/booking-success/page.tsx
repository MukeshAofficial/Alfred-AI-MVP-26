...
function BookingDetailsFallback() {
  return <p className="text-center py-4">Loading booking details...</p>;
}
          ...
          {loading ? (
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <p className="text-gray-600">
                  {service.spa?.name} - {service.spa?.location}
                </p>
              </div>
  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-1 container mx-auto px-4 py-6 pb-20">
        <Suspense fallback={<BookingDetailsFallback />}>
          <BookingDetails />
        </Suspense>
        <div className="max-w-md mx-auto text-center">
          ...
          <div className="mt-6 p-4 bg-amber-50 border border-amber-200 rounded-md text-sm text-amber-800">
            ...
            <p>
              It may take a few moments for your booking to appear in your
              bookings list while our system processes the payment confirmation.
            </p>
          </div>
        </div>
      </main>
