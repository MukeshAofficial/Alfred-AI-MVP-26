      ...
      <main className="flex-1 container mx-auto px-4 py-6 pb-20">
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">{partySize} {parseInt(partySize || '1') === 1 ? 'person' : 'people'}</p>
                  </div>
                </div>
        ...
        <div className="max-w-md mx-auto text-center">
          ...
          <div className="mt-6 p-4 bg-amber-50 border border-amber-200 rounded-md text-sm text-amber-800">
            ...
            <p>It may take a few moments for your reservation to appear in your bookings list while our system processes the payment confirmation.</p>
